...
export class PopupContentComponent {
  ...
  handleClickOutside = (e: Event) => {
    if (
      ...
      this.popupService.triggerRef?.nativeElement.contains(e.target as Node) ||
      this.contentRef?.nativeElement?.contains(e.target as Node)
    ) {
      return;
    }
  ...
  handleMouseWheel = () => this.popupService.close();
